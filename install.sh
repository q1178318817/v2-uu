...
install_v2-ui() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/v2-ui-linux.tar.gz https://github.com/q1178318817/v2-uu/releases/download/${last_version}/v2-ui-linux.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/q1178318817/v2-uu/releases/download/${last_version}/v2-ui-linux.tar.gz"
